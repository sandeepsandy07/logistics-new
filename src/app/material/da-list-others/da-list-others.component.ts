...
@Component({
  selector: 'app-da-list-others',
  templateUrl: './da-list-others.component.html',
  styleUrls: ['./da-list-others.component.css']
})
export class DaListOthersComponent implements OnInit {
  ...
  getListOfDispatchValues(){
    let data={ 
      ...
      status_approver:'da_view_employees'
