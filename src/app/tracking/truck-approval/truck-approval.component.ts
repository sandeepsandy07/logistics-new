...
export class TruckApprovalComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['Sl.no.','DA no','State','District','Taluk','Transportation','Status','RequestDate','Remarks','RequestedBy','Approve','Action'];
  //public displayedColumns: string[] = ['Sl.no.','RequestDate','Remarks','Status','DestinationId','RequestedBy','Approve','Action'];
